	...
	<div class="row">
      ...
      <div class="alert alert-success alert-dismissible fade show" role="alert">
			...
			<div class="card shadow-custom border-0">
             ...
             @csrf
                ...
                <div class="d-block mb-2">
                  <img class="bg-secondary" src="{{url('/img/logo.png')}}" style="width:100px">
                </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img/watermark.png')}}" style="width:100px">
                </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img/slider-1.jpg')}}" style="width:200px">
                </div>
                ...
                <small class="d-block">{{ __('misc.recommended_size') }} 1600x900 px (JPG)</small>
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img/slider-2.jpg')}}" style="width:200px">
                </div>
                ...
                <small class="d-block">{{ __('misc.recommended_size') }} 1600x900 px (JPG)</small>
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img/slider-3.jpg')}}" style="width:200px">
                </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/avatar/default.jpg')}}" style="width:180px">
                </div>
            ...
            <div class="row mb-3">
		          ...
		          <div class="col-lg-5 col-sm-10">
                <div class="d-block mb-2">
                  <img src="{{url('/img-category/default.jpg')}}" style="width:200px">
                </div>
