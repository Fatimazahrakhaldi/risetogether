...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
  <head>
    ...
    <link href="{{ asset('css/core.css') }}?v={{$settings->version}}" rel="stylesheet">
    <link href="{{ asset('css/bootstrap/bootstrap.min.css') }}?v={{$settings->version}}" rel="stylesheet">
    <link href="{{ asset('css/bootstrap-icons.css') }}?v={{$settings->version}}" rel="stylesheet">
    <link href="{{ asset('css/admin-styles.css') }}?v={{$settings->version}}" rel="stylesheet">
  ...
  <div class="popout font-default"></div>
    ...
    <main>
      ...
      <div class="offcanvas-header">
          <h5 class="offcanvas-title"><img src="{{ url('img/logo.png') }}" width="75" /></h5>
      ...
      <div class="d-flex align-items-center">
        ...
        <div class="flex-shrink-0 dropdown">
          <a href="#" class="d-block link-dark text-decoration-none" id="dropdownUser2" data-bs-toggle="dropdown" aria-expanded="false">
           <img src="{{ asset('avatar').'/'.auth()->user()->avatar }}" width="32" height="32" class="rounded-circle">
          </a>
  ...
  <!--<footer class="admin-footer px-4 py-3 bg-white shadow-custom">
    ...
    <script src="{{ asset('js/admin-functions.js') }}?v={{$settings->version}}"></script>
