  ...
  <nav class="navbar navbar-expand-lg navbar-inverse fixed-top py-0 @if(request()->path() == '/') scroll @else shadow-sm bg-dark @endif">
    <div class="container d-flex fw-bold">
      <a class="navbar-brand" href="{{ url('/') }}">
        <img src="{{ asset('img/logo.png') }}" style="max-width: 55px;"class="align-baseline" alt="{{$settings->title}}" />
      </a>
          ...
          @auth
            <li class="nav-item me-1 dropdown">
              <a class="nav-link dropdown-toggle" href="#" id="dropdown03"data-bs-toggle="dropdown" aria-expanded="false">
                <img src="{{ asset('avatar').'/'.auth()->user()->avatar }}" alt="User" class="rounded-circle avatarUser" width="25" height="25" />
