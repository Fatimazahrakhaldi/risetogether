...
<div class="container py-5">
    ...
    <form method="POST" action="" enctype="multipart/form-data" id="formUpdate">
		...
		<div class="filer-input-dragDrop position-relative hoverClass" id="draggable">
			...
			<!-- previewPhoto -->
			<div class="previewPhoto" style='display: block; background-image: url("{{asset('campaigns/large/'.$data->large_image)}}");'>
...
@section('javascript')
  ...
  <script src="{{ asset('js/create-edit-campaign.js')}}"></script>
@endsection
