...
<meta property="og:image:width" content="{{App\Helper::getWidth('campaigns/large/'.$response->large_image)}}"/>
<meta property="og:image:height" content="{{App\Helper::getHeight('campaigns/large/'.$response->large_image)}}"/>
...
<meta property="og:image" content="{{url('campaigns/large',$response->large_image)}}"/>
...
<meta name="twitter:image" content="{{url('campaigns/large',$response->large_image)}}" />
...
<div class="col-md-7 margin-bottom-20">
	...
	@if ($response->video == '')
		<img class="img-fluid rounded-lg" style="display: inline-block;" src="{{ url('campaigns/large',$response->large_image) }}" />
	@else
	  ...
	  <div class="panel-body">
	    <div class="media none-overflow">
			  <div class="d-flex my-2 align-items-center">
			      <img class="rounded-circle mr-2" src="{{url('avatar',$response->user()->avatar)}}" width="60" height="60">
...
@section('javascript')
	<script src="{{ asset('js/pagination-updates-donations.js') }}?v={{$settings->version}}"></script>
