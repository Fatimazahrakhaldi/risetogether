...
<div class="jumbotron mb-0 bg-sections text-center" style="background-image: url('{{ url('campaigns/large', $response->large_image) }}')">
...
@section('javascript')
<script src="{{ asset('js/donate.js') }}?v={{$settings->version}}"></script>
